...
import "../style.css";
import AccordionDash from "../component/Chart3d";
                ...
                <Stack spacing={2} direction="row">
                  ...
                  >
                    <CardContent>
                      ...
                      <span>$ <CountUp delay={1} start={0} end={6372638} duration={4} />K</span>
                      </Typography>
                  ...
                  >
                    <CardContent>
                      ...
                      <Typography gutterBottom variant="h5" component="div">
                      <span>$ <CountUp delay={1} start={0} end={918392} duration={4} />K</span>
                      </Typography>
                      <Typography gutterBottom variant="body2" component="div">
                        Toatal Order
                      </Typography>
              ...
              <Grid item xs={4}>
                <Stack spacing={2}>
                  <Card sx={{ p: 0.3, backgroundColor: "#5ee1ff7a" }}>
                    <CardContent>
                    <span>$ <CountUp delay={1} start={0} end={237238} duration={4} />K</span>
                      <br />
                  ...
                  <Card sx={{ p: 0.3, backgroundColor: "aliceblue" }}>
                    <CardContent>
                      <span>$ <CountUp delay={1} start={0} end={30020} duration={4} />K</span>
                      <br />
                      <span>Total Income</span>
                    </CardContent>
                  </Card>
